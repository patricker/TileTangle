...
fn playground_diamond_overlay_is_valid() {
    ...
    let edges = vec![
        (0, 2, "S"), (1, 2, "E"), (1, 5, "S"), (2, 3, "E"), (2, 1, "W"), (2, 0, "N"),
        (2, 6, "S"), (3, 2, "W"), (3, 7, "S"), (4, 5, "E"), (4, 10, "S"), (5, 6, "E"),
        (5, 4, "W"), (5, 1, "N"), (5, 11, "S"), (6, 7, "E"), (6, 5, "W"), (6, 2, "N"),
        (6, 12, "S"), (7, 8, "E"), (7, 6, "W"), (7, 3, "N"), (7, 13, "S"), (8, 7, "W"),
        (8, 14, "S"), (9, 10, "E"), (9, 17, "S"), (10, 11, "E"), (10, 9, "W"),
        (10, 4, "N"), (10, 18, "S"), (11, 12, "E"), (11, 10, "W"), (11, 5, "N"),
        (11, 19, "S"), (12, 13, "E"), (12, 11, "W"), (12, 6, "N"), (12, 20, "S"),
        (13, 14, "E"), (13, 12, "W"), (13, 7, "N"), (13, 21, "S"), (14, 15, "E"),
        (14, 13, "W"), (14, 8, "N"), (14, 22, "S"), (15, 14, "W"), (15, 23, "S"),
        (16, 17, "E"), (17, 18, "E"), (17, 16, "W"), (17, 9, "N"), (17, 25, "S"),
        (18, 19, "E"), (18, 17, "W"), (18, 10, "N"), (18, 26, "S"), (19, 20, "E"),
        (19, 18, "W"), (19, 11, "N"), (19, 27, "S"), (20, 21, "E"), (20, 19, "W"),
        (20, 12, "N"), (20, 28, "S"), (21, 22, "E"), (21, 20, "W"), (21, 13, "N"),
        (21, 29, "S"), (22, 23, "E"), (22, 21, "W"), (22, 14, "N"), (22, 30, "S"),
        (23, 24, "E"), (23, 22, "W"), (23, 15, "N"), (23, 31, "S"), (24, 23, "W"),
        (25, 26, "E"), (25, 17, "N"), (26, 27, "E"), (26, 25, "W"), (26, 18, "N"),
        (26, 32, "S"), (27, 28, "E"), (27, 26, "W"), (27, 19, "N"), (27, 33, "S"),
        (28, 29, "E"), (28, 27, "W"), (28, 20, "N"), (28, 34, "S"), (29, 30, "E"),
        (29, 28, "W"), (29, 21, "N"), (29, 35, "S"), (30, 31, "E"), (30, 29, "W"),
        (30, 22, "N"), (30, 36, "S"), (31, 30, "W"), (31, 23, "N"), (32, 33, "E"),
        (32, 26, "N"), (33, 34, "E"), (33, 32, "W"), (33, 27, "N"), (33, 37, "S"),
        (34, 35, "E"), (34, 33, "W"), (34, 28, "N"), (34, 38, "S"), (35, 36, "E"),
        (35, 34, "W"), (35, 29, "N"), (35, 39, "S"), (36, 35, "W"), (36, 30, "N"),
        (37, 38, "E"), (37, 33, "N"), (38, 39, "E"), (38, 37, "W"), (38, 34, "N"),
        (38, 40, "S"), (39, 38, "W"), (39, 35, "N"), (40, 38, "N"),
    ];
    let edges = edges
        .into_iter()
