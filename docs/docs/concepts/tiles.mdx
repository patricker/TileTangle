...
Tiles can be classic one-letter pieces, emoji graphemes, or multi-character stacks. Try stacking on
existing tiles to see how the engine maintains per-cell history.
