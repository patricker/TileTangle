...
- **GaddagDictionary** — specialised structure for Scrabble-style move generation. Provides both
...
Below is a small, precomputed snapshot (10k TWL06 words on an M1 Pro). Interpret it as directional guidance; your workload will differ.
